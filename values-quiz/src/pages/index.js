...
import sampleData from "../components/UserProfile/sampleData.json"
    ...
    <Layout>
      <ProfileContainer>
        <Heading as="h1" fontSize={[4, 5]} color="primary">
          Below is a sample profile page with info generated by ChatGPT using
          quiz answers. Login to take the quiz yourself!
        </Heading>
